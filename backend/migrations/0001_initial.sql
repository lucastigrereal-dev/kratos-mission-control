...
INSERT OR IGNORE INTO appointments (id, titulo, data, horario, tipo, descricao, projeto_id, status, criado_em, atualizado_em)
VALUES
  ('e0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Deep Work · KRATOS', date('now'), '08:00', 'deep_work', 'Foco no cockpit de missão', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a00', 'pending', datetime('now'), datetime('now')),
  ('e0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22', 'Review semanal Publisher OS', date('now'), '14:00', 'review', 'Métricas e ajustes de conteúdo', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a01', 'pending', datetime('now'), datetime('now'));
